  ...
  return (
    <main className=''>
      ...
      <h1
        ...
        Best <br className='lg:hidden' /> <span className='text-zinc font-bold'>Web Design</span> and <span className='text-zinc font-bold'>Development</span> Agency
      </h1>

      <section
        className='py-6 text-gray-600 flex flex-col lg:flex-row lg:justify-between'
      >
